...
public class ReflectionTest {
    public static void main(String[] args) throws ReflectiveOperationException {
        ...
        // print class modifers, name, and superclass name (if !=Object)
    ...
    public static void printMethods(Class cl) {
        ...
        for (Method m : methods) {
            ...
            System.out.print("   ");
            // print modifiers, renturn type and method name
    ...
    public static void printPermittedSubclasses(Class cl) {
        if (cl.isSealed()) {
            ...
            for (int i = 0; i < permittedSubclasses.length; i++) {
                if (i == 0) System.out.print(" permits");
    ...
    public static void printInterfaces(Class cl) {
        ...
        for (int i = 0; i < interfaces.length; i++) {
            if (i == 0) System.out.print(cl.isInterface() ? " extends " : " implements ");
            else
                System.out.print(", ");
